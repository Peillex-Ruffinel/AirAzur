...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 21 Septembre 2017 à 14:29
...
INSERT INTO `utilisateur` (`numutil`, `nom`, `prenom`, `email`, `datenaiss`, `adress`, `ville`, `cp`) VALUES
(1, 'Bost', 'Anne', 'bost.anne@gmail.com', '1986-06-21', '15 rue de pavillon', 'Le Blanc-Mesnil', '93150'),
(2, 'Marguet', 'Céline', 'marguet.celine@gmail.com', '1995-07-07', '230 avenue Jean Jaurès', 'Drancy', '93700');
...
('2', 'AIR5108', 'Paris CDG - France', 'Londre - Angleterre', '23/04/2011 13:00', '23/04/2011 18:20', 300, 2, 600);
