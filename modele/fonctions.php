<?php
//fonction qui recupere les vols
function getLesVols() {
$vols = array();
$v = 0;
...
//fonction qui recupere le NumUtilisateur
...
//fonction qui insert dans la bdd et enregistre les variable de sessions
...
//fonction qui recupere les reservations
...
//fonction qui recupere l'IdUtil
function getIdUtil(){
    $idutil =  $_REQUEST["idutil"];
    return $idutil;
}

//fonction qui recupere l'IdVol
function getIdVol(){
    $idvol =  $_REQUEST["idvol"];
    return $idvol;
}

//fonction qui recupere une reservation
